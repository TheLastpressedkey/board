...
export function PlayerView({
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden relative pointer-events-none">
      ...
      <div
        className="absolute inset-0 flex items-end pointer-events-auto"
      ...
      {/* Playlist Sidebar */}
      {showPlaylist && (
        <div className="absolute right-0 top-0 bottom-0 w-80 md:w-96 bg-gray-900/98 backdrop-blur-xl z-40 flex flex-col border-l border-white/10 shadow-2xl pointer-events-auto">
