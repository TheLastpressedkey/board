...
import { Calculator, Table, X, Search, Plus, Clock, ListTodo, Calendar, Rss, Activity, Layout, Mail, FileText, FolderOpen, Pencil, Key } from 'lucide-react';
...
export function AppStore({ onSelect, onClose }: AppStoreProps) {
  ...
  const apps: AppInfo[] = [
    ...
    },
    {
      id: 'password-manager',
      name: '1PSWD',
      description: 'Secure password manager to generate and store passwords for all your services',
      icon: Key,
      category: 'Security',
      author: 'Core Apps'
    }
