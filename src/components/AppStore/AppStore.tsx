...
import { Calculator, Table, X, Search, Plus, Clock, ListTodo, Calendar, Rss, Activity, Layout, Mail, FileText, FolderOpen, Pencil, Youtube, Cloud, Terminal, ClipboardList, Music2 } from 'lucide-react';
